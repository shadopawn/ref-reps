...
public class BodySourceViewTitle : MonoBehaviour
{
    ...
    void Update () 
    {
        ...
        foreach (ulong trackingId in knownIds)
        {
            if(!trackedIds.Contains(trackingId))
            {
                ...
                BodyErrorMessage.GetComponent<Animator>().SetBool("isEnabled", true);
        ...
        foreach (var body in data)
        {
            ...
            if(body.IsTracked)
            {
                BodyErrorMessage.GetComponent<Animator>().SetBool("isEnabled", false);
